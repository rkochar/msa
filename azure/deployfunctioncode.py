...
#         super().__init__("azure:deployfunctioncode:DeployFunctionCode", f"{function_app}-serverless_code", None, opts)
#
#         handler_path = handler.replace(".", "-")
#         output = run(["func", "azure", "functionapp", "publish", function_app],
#                      cwd=f"./serverless_code/azure/{handler_path}",
#                      stdout=PIPE,
#                      stderr=STDOUT,
#                      )
#         print("Deploying serverless_code to function_app")
...
#         # print(f"Deploying serverless_code to function_app {function_app}\n{output}")
